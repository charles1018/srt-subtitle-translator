...
class App:
    ...
    def _apply_user_settings(self) -> None:
        ...
        # 啟動時把儲存的 source/target 同步到 PromptManager，避免 user_settings 與
        # prompt_config 漂移（後續使用者切下拉會經由 on_source_target_lang_changed 持續同步）
        self.gui.on_source_target_lang_changed()
