...
class GUIComponents:
    ...
    def setup(self):
        ...
        llm_types = ["ollama", "openai", "anthropic", "google", "llamacpp"]
...
class PromptEditorWindow:
    ...
    def __init__(self, parent, prompt_manager):
        ...
        llm_type_combo = ttk.Combobox(
            options_frame, textvariable=self.llm_type_var, values=["ollama", "openai", "anthropic", "google", "llamacpp"], state="readonly", width=10
        )
